...
urlpatterns = [
    path('', views.get_debt_credit_list, name='debit_credit_list'),
    ...
    path('<int:credit_id>/edit', views.edit_credit, name='edit_credit'),
    path('<int:credit_id>/delete', views.delete_credit, name='delete_credit'),
]
